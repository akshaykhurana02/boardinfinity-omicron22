...
const UseEffectComponent = () => {
  ...
  */
  ...
  // useEffect(() => {
  //   console.log("I will be called on first render and on every other render!");
  // });
  ...
  */
  ...
  /* Case 3 -> Dependency Array is present, and has some value/condition present
    It will be called on selective operations OR It will behave like shouldComponentUpdate
